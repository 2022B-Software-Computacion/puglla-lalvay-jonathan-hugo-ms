package com.example.jhpl_instagram.adapter
...
import com.example.jhpl_instagram.activity.DetailActivity
...
class PostAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (cometChatUserId == post.author!!.uid) {
        ...
        Glide.with(context)
            .load(heartIcon)
            .into(holder.heartIv)
        holder.followTxt.setOnClickListener {
            toggleFollow(post)
        }
        holder.heartIv.setOnClickListener {
            toggleLike(post)
        }
        holder.postContentIv.setOnClickListener {
            goToDetail(post)
        }
        holder.postContentVv.setOnClickListener {
            goToDetail(post)
        }
    }
