            ...
            if (messageType == CometChatConstants.MESSAGE_TYPE_TEXT) {
                ...
                try {
                    ...
                    for (i in 0 until options.length()) {
                        ...
                        textViewOption.setTextAppearance(this, com.ocetnik.timer.R.style.TextAppearance_AppCompat_Medium)
                        textViewPercentage.setTextAppearance(this, com.ocetnik.timer.R.style.TextAppearance_AppCompat_Medium)
