        ...
        if (messageType == CometChatConstants.MESSAGE_TYPE_IMAGE) {
            ...
            try {
                ...
                for (k in 0 until options.length()) {
                    ...
                    textViewOption.setTextAppearance(context, com.ocetnik.timer.R.style.TextAppearance_AppCompat_Medium)
                    textViewPercentage.setTextAppearance(context, com.ocetnik.timer.R.style.TextAppearance_AppCompat_Medium)
...
//            chip.chipStrokeColor = ColorStateList.valueOf(context!!.resources.getColor(R.color.colorPrimaryDark))
    ...
    private fun initLocation() {
        ...
        if (Utils.hasPermissions(context, *arrayOf(Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION))) {
            try {
                locationListener.let { if (ActivityCompat.checkSelfPermission(
                        context!!,
                        Manifest.permission.ACCESS_FINE_LOCATION
                    ...
                    locationManager?.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, MIN_TIME, MIN_DIST.toFloat(), it) }
